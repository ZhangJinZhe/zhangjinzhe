...
<body>
	...
	<div class="soubg">
		<div class="sou">
			...
			<!--End 所在收货地区 End-->
			<span class="fr"> <span class="fl"> <c:choose>
						<c:when test="${sessionScope.username!=null}">您好，${sessionScope.username}</c:when>
						<c:otherwise>您好,请<a href="<%=path%>/LoginCookie">登录</a>&nbsp; <a
								href="<%=path%>/pages/front/Regist.jsp" style="color: #ff4e00;">免费注册</a>
						</c:otherwise>
	...
	<div class="top">
		...
		<div class="i_car">
			...
			<div class="car_bg">
				<!--Begin 购物车未登录 Begin-->
				<div class="un_login">
					还未登录！<a href="LoginCookie" style="color: #ff4e00;">马上登录</a> 查看购物车！
				</div>
				<!--End 购物车未登录 End-->
				<!--Begin 购物车已登录 Begin-->
				<ul class="cars">
					<li>
						<div class="img">
							<a href="#"><img src="resources/images/car1.jpg" width="58"
								height="58" /></a>
						</div>
						<div class="name">
					...
					<li>
						<div class="img">
							<a href="#"><img src="resources/images/car2.jpg" width="58"
								height="58" /></a>
						</div>
						<div class="name">
		...
		<div class="menu">
							...
							<li>
								<div class="fj">
									<span class="n_img"><span></span><img
										src="resources/images/nav1.png" /></span> <span class="fl" data-value="${list.id }">${list.nav }</span>
								</div>
								<div class="zj">
									<div class="zj_l"></div>
									<div class="zj_r">
										<a href="#"><img src="resources/images/n_img1.jpg"
											width="236" height="200" /></a> <a href="#"><img
											src="resources/images/n_img2.jpg" width="236" height="200" /></a>
									</div>
								</div>
							</li>
						</c:forEach>
			...
			<ul class="menu_r">
				...
				<c:forEach items="${list}" var="list">
					<li><a href="${list.url }">${list.nav }</a></li>
				</c:forEach>
			</ul>
	...
	<div class="i_bg bg_color">
		<div class="i_ban_bg">
			...
			<div class="banner">
				<div class="top_slide_wrap">
					<ul class="slide_box bxslider">
						<li><img src="resources/images/ban1.jpg" width="740"
							height="401" /></li>
						<li><img src="resources/images/ban1.jpg" width="740"
							height="401" /></li>
						<li><img src="resources/images/ban1.jpg" width="740"
			...
			<div class="inews">
				...
				<ul>
					<c:forEach items="${listNews }" var="map">
						<li><span>[ ${map.type} ]</span><a href="${map.href }">${map.content }</a></li>
					</c:forEach>
				</ul>
				<div class="charge_t">
					话费充值
		...
		<div class="content mar_10">
			<div class="h_l_img">
				<div class="img">
					<img src="resources/images/l_img.jpg" width="188" height="188" />
				</div>
				<div class="pri_bg">
							...
							<div id="botton-scroll">
								<ul class="featureUL">
									<li class="featureBox">
										<div class="box">
											<div class="h_icon">
												<img src="resources/images/hot.png" width="50" height="50" />
											</div>
											<div class="imgbg">
												<a href="#"><img src="resources/images/hot1.jpg"
									...
									<li class="featureBox">
										<div class="box">
											...
											<div class="imgbg">
												<a href="#"><img src="resources/images/hot2.jpg"
													width="160" height="136" /></a>
											</div>
											<div class="name">
												<a href="#">
									...
									<li class="featureBox">
										<div class="box">
											...
											<div class="imgbg">
												<a href="#"><img src="resources/images/hot3.jpg"
													width="160" height="136" /></a>
											</div>
											<div class="name">
												<a href="#">
									...
									<li class="featureBox">
										<div class="box">
											...
											<div class="imgbg">
												<a href="#"><img src="resources/images/hot4.jpg"
													width="160" height="136" /></a>
											</div>
											<div class="name">
												<a href="#">
		...
		<div class="content">
			<div class="i_sell">
				<div id="imgPlay">
					<ul class="imgs" id="actor">
						<li><a href="#"><img src="resources/images/tm_r.jpg"
			...
			<div class="sell_right">
				<div class="sell_1">
					<div class="s_img">
						<a href="#"><img src="resources/images/tm_1.jpg" width="185"
							height="155" /></a>
					</div>
					<div class="s_price">
						￥<span>89</span>
				...
				<div class="sell_2">
					<div class="s_img">
						<a href="#"><img src="resources/images/tm_2.jpg" width="185"
							height="155" /></a>
					</div>
					<div class="s_price">
						￥<span>289</span>
				...
				<div class="sell_b1">
					<div class="sb_img">
						<a href="#"><img src="resources/images/tm_b1.jpg" width="242"
							height="356" /></a>
					</div>
					<div class="s_price">
						￥<span>289</span>
				...
				<div class="sell_3">
					<div class="s_img">
						<a href="#"><img src="resources/images/tm_3.jpg" width="185"
							height="155" /></a>
					</div>
					<div class="s_price">
						￥<span>289</span>
				...
				<div class="sell_4">
					<div class="s_img">
						<a href="#"><img src="resources/images/tm_4.jpg" width="185"
							height="155" /></a>
					</div>
					<div class="s_price">
						￥<span>289</span>
				...
				<div class="sell_b2">
					<div class="sb_img">
						<a href="#"><img src="resources/images/tm_b2.jpg" width="242"
							height="356" /></a>
					</div>
					<div class="s_price">
						￥<span>289</span>
		...
		<div class="content">
				...
				<div class="fre_ban">
					<div id="imgPlay1">
						<ul class="imgs" id="actor1">
							<li><a href="#"><img src="resources/images/fre_r.jpg"
			...
			<div class="fresh_mid">
				<ul>
					<li>
						...
						<div class="img">
							<a href="#"><img src="resources/images/fre_1.jpg" width="185"
								height="155" /></a>
						</div>
					</li>
					<li>
						...
						<div class="img">
							<a href="#"><img src="resources/images/fre_2.jpg" width="185"
								height="155" /></a>
						</div>
					</li>
					<li>
						...
						<div class="img">
							<a href="#"><img src="resources/images/fre_3.jpg" width="185"
								height="155" /></a>
						</div>
					</li>
					<li>
						...
						<div class="img">
							<a href="#"><img src="resources/images/fre_4.jpg" width="185"
								height="155" /></a>
						</div>
					</li>
					<li>
						...
						<div class="img">
							<a href="#"><img src="resources/images/fre_5.jpg" width="185"
								height="155" /></a>
						</div>
					</li>
					<li>
						...
						<div class="img">
							<a href="#"><img src="resources/images/fre_6.jpg" width="185"
								height="155" /></a>
						</div>
					</li>
				</ul>
			...
			<div class="fresh_right">
				<ul>
					<li><a href="#"><img src="resources/images/fre_b1.jpg"
							width="260" height="220" /></a></li>
					<li><a href="#"><img src="resources/images/fre_b2.jpg"
							width="260" height="220" /></a></li>
				</ul>
			</div>
		</div>
		...
		<div class="content">
				...
				<div class="food_ban">
					<div id="imgPlay2">
						<ul class="imgs" id="actor2">
							<li><a href="#"><img src="resources/images/food_r.jpg"
									width="211" height="286" /></a></li>
							<li><a href="#"><img src="resources/images/food_r.jpg"
									width="211" height="286" /></a></li>
							<li><a href="#"><img src="resources/images/food_r.jpg"
			...
			<div class="fresh_mid">
				<ul>
					<li>
						...
						<div class="img">
							<a href="#"><img src="resources/images/food_1.jpg"
					...
					<li>
						...
						<div class="img">
							<a href="#"><img src="resources/images/food_2.jpg"
								width="185" height="155" /></a>
						</div>
					</li>
					<li>
						...
						<div class="img">
							<a href="#"><img src="resources/images/food_3.jpg"
								width="185" height="155" /></a>
						</div>
					</li>
					<li>
						...
						<div class="img">
							<a href="#"><img src="resources/images/food_4.jpg"
								width="185" height="155" /></a>
						</div>
					</li>
					<li>
						...
						<div class="img">
							<a href="#"><img src="resources/images/food_5.jpg"
								width="185" height="155" /></a>
						</div>
					</li>
					<li>
						...
						<div class="img">
							<a href="#"><img src="resources/images/food_6.jpg"
								width="185" height="155" /></a>
						</div>
					</li>
				</ul>
			...
			<div class="fresh_right">
				<ul>
					<li><a href="#"><img src="resources/images/food_b1.jpg"
							width="260" height="220" /></a></li>
					<li><a href="#"><img src="resources/images/food_b2.jpg"
							width="260" height="220" /></a></li>
				</ul>
			</div>
		</div>
		...
		<div class="content">
				...
				<div class="make_ban">
					<div id="imgPlay3">
						<ul class="imgs" id="actor3">
							<li><a href="#"><img src="resources/images/make_r.jpg"
									width="211" height="286" /></a></li>
							<li><a href="#"><img src="resources/images/make_r.jpg"
									width="211" height="286" /></a></li>
							<li><a href="#"><img src="resources/images/make_r.jpg"
			...
			<div class="fresh_mid">
				<ul>
					<li>
						...
						<div class="img">
							<a href="#"><img src="resources/images/make_1.jpg"
								width="185" height="155" /></a>
						</div>
					</li>
					<li>
						...
						<div class="img">
							<a href="#"><img src="resources/images/make_2.jpg"
								width="185" height="155" /></a>
						</div>
					</li>
					<li>
						...
						<div class="img">
							<a href="#"><img src="resources/images/make_3.jpg"
								width="185" height="155" /></a>
						</div>
					</li>
					<li>
						...
						<div class="img">
							<a href="#"><img src="resources/images/make_4.jpg"
								width="185" height="155" /></a>
						</div>
					</li>
					<li>
						...
						<div class="img">
							<a href="#"><img src="resources/images/make_5.jpg"
								width="185" height="155" /></a>
						</div>
					</li>
					<li>
						...
						<div class="img">
							<a href="#"><img src="resources/images/make_6.jpg"
								width="185" height="155" /></a>
						</div>
					</li>
				</ul>
			...
			<div class="fresh_right">
				<ul>
					<li><a href="#"><img src="resources/images/make_b1.jpg"
							width="260" height="220" /></a></li>
					<li><a href="#"><img src="resources/images/make_b2.jpg"
							width="260" height="220" /></a></li>
				</ul>
			</div>
		</div>
		...
		<div class="content">
				...
				<div class="baby_ban">
					<div id="imgPlay4">
						<ul class="imgs" id="actor4">
							<li><a href="#"><img src="resources/images/baby_r.jpg"
									width="211" height="286" /></a></li>
							<li><a href="#"><img src="resources/images/baby_r.jpg"
									width="211" height="286" /></a></li>
							<li><a href="#"><img src="resources/images/baby_r.jpg"
			...
			<div class="fresh_mid">
				<ul>
					<li>
						...
						<div class="img">
							<a href="#"><img src="resources/images/baby_1.jpg"
								width="185" height="155" /></a>
						</div>
					</li>
					<li>
						...
						<div class="img">
							<a href="#"><img src="resources/images/baby_2.jpg"
								width="185" height="155" /></a>
						</div>
					</li>
					<li>
						...
						<div class="img">
							<a href="#"><img src="resources/images/baby_3.jpg"
								width="185" height="155" /></a>
						</div>
					</li>
					<li>
						...
						<div class="img">
							<a href="#"><img src="resources/images/baby_4.jpg"
								width="185" height="155" /></a>
						</div>
					</li>
					<li>
						...
						<div class="img">
							<a href="#"><img src="resources/images/baby_5.jpg"
								width="185" height="155" /></a>
						</div>
					</li>
					<li>
						...
						<div class="img">
							<a href="#"><img src="resources/images/baby_6.jpg"
								width="185" height="155" /></a>
						</div>
					</li>
				</ul>
			...
			<div class="fresh_right">
				<ul>
					<li><a href="#"><img src="resources/images/baby_b1.jpg"
							width="260" height="220" /></a></li>
					<li><a href="#"><img src="resources/images/baby_b2.jpg"
							width="260" height="220" /></a></li>
				</ul>
			</div>
		</div>
		...
		<div class="content">
				...
				<div class="home_ban">
					<div id="imgPlay5">
						<ul class="imgs" id="actor5">
							<li><a href="#"><img src="resources/images/home_r.jpg"
									width="211" height="286" /></a></li>
							<li><a href="#"><img src="resources/images/home_r.jpg"
									width="211" height="286" /></a></li>
							<li><a href="#"><img src="resources/images/home_r.jpg"
			...
			<div class="fresh_mid">
				<ul>
					<li>
						...
						<div class="img">
							<a href="#"><img src="resources/images/home_1.jpg"
								width="185" height="155" /></a>
						</div>
					</li>
					<li>
						...
						<div class="img">
							<a href="#"><img src="resources/images/home_2.jpg"
								width="185" height="155" /></a>
						</div>
					</li>
					<li>
						...
						<div class="img">
							<a href="#"><img src="resources/images/home_3.jpg"
								width="185" height="155" /></a>
						</div>
					</li>
					<li>
						...
						<div class="img">
							<a href="#"><img src="resources/images/home_4.jpg"
								width="185" height="155" /></a>
						</div>
					</li>
					<li>
						...
						<div class="img">
							<a href="#"><img src="resources/images/home_5.jpg"
								width="185" height="155" /></a>
						</div>
					</li>
					<li>
						...
						<div class="img">
							<a href="#"><img src="resources/images/home_6.jpg"
								width="185" height="155" /></a>
						</div>
					</li>
				</ul>
			...
			<div class="fresh_right">
				<ul>
					<li><a href="#"><img src="resources/images/home_b1.jpg"
							width="260" height="220" /></a></li>
					<li><a href="#"><img src="resources/images/home_b2.jpg"
							width="260" height="220" /></a></li>
				</ul>
			</div>
		</div>
		...
		<div class="content">
				...
				<div class="tel_ban">
					<div id="imgPlay6">
						<ul class="imgs" id="actor6">
							<li><a href="#"><img src="resources/images/tel_r.jpg"
									width="211" height="286" /></a></li>
							<li><a href="#"><img src="resources/images/tel_r.jpg"
									width="211" height="286" /></a></li>
							<li><a href="#"><img src="resources/images/tel_r.jpg"
			...
			<div class="fresh_mid">
				<ul>
					<li>
						...
						<div class="img">
							<a href="#"><img src="resources/images/tel_1.jpg" width="185"
								height="155" /></a>
						</div>
					</li>
					<li>
						...
						<div class="img">
							<a href="#"><img src="resources/images/tel_2.jpg" width="185"
								height="155" /></a>
						</div>
					</li>
					<li>
						...
						<div class="img">
							<a href="#"><img src="resources/images/tel_3.jpg" width="185"
								height="155" /></a>
						</div>
					</li>
					<li>
						...
						<div class="img">
							<a href="#"><img src="resources/images/tel_4.jpg" width="185"
								height="155" /></a>
						</div>
					</li>
					<li>
						...
						<div class="img">
							<a href="#"><img src="resources/images/tel_5.jpg" width="185"
								height="155" /></a>
						</div>
					</li>
					<li>
						...
						<div class="img">
							<a href="#"><img src="resources/images/tel_6.jpg" width="185"
								height="155" /></a>
						</div>
					</li>
				</ul>
			...
			<div class="fresh_right">
				<ul>
					<li><a href="#"><img src="resources/images/tel_b1.jpg"
							width="260" height="220" /></a></li>
					<li><a href="#"><img src="resources/images/tel_b2.jpg"
							width="260" height="220" /></a></li>
				</ul>
			</div>
		</div>
		...
		<div class="b_btm_bg b_btm_c">
			<div class="b_btm">
				<table border="0"
					...
					cellspacing="0" cellpadding="0">
					<tr>
						<td width="72"><img src="resources/images/b1.png" width="62"
							height="62" /></td>
				...
				<table border="0"
					...
					cellspacing="0" cellpadding="0">
					<tr>
						<td width="72"><img src="resources/images/b2.png" width="62"
							height="62" /></td>
				...
				<table border="0"
					...
					cellspacing="0" cellpadding="0">
					<tr>
						<td width="72"><img src="resources/images/b3.png" width="62"
							height="62" /></td>
				...
				<table border="0"
					...
					cellspacing="0" cellpadding="0">
					<tr>
						<td width="72"><img src="resources/images/b4.png" width="62"
							height="62" /></td>
		...
		<div class="b_nav">
			...
			<div class="b_er">
				<div class="b_er_c">
					<img src="resources/images/er.gif" width="118" height="118" />
				</div>
...
<div class="top">
	<div class="logo">
		<a href="${ctx}/Home?action=index"><img
			src="${ctx}/statics/resources/images/logo.png"></a>
	</div>
	<div class="search">
		<form>
					...
					<li>
						<div class="img">
							<a href="javascript:void(0)"> <img
								src="${ctx}/statics/resources/images/car1.jpg" width="58"
								height="58">
							</a>
						</div>
						<div class="name">
