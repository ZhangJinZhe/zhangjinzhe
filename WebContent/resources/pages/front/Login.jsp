...
<div class="soubg">
	<div class="sou">
        <span class="fr">
        	<span class="fl">你好，请<a href="Login.html">登录</a>&nbsp;<a href="<%=path %>/pages/front/Regist.jsp" style="color:#ff4e00;">免费注册</a>&nbsp;</span>
...
<div class="log_bg">	
	...
	<div class="login">
		...
		<div class="log_c">
            ...
            <table border="0" style="width:370px; font-size:14px; margin-top:30px;" cellspacing="0" cellpadding="0">
              <tr height="50" valign="top">
                ...
                <td>
                    ...
                    <span class="fr">还没有商城账号，<a href="<%=path %>/pages/front/Regist.jsp" style="color:#ff4e00;">立即注册</a></span>
                </td>
              </tr>
              <c:choose>
        	...
        	<tr height="70">
                <td>用户名</td>
                <td><input type="text" value="${Login}" class="l_user" name="Login"/></td>
              </tr>
              <tr height="70">
                <td>密&nbsp; &nbsp; 码</td>
                <td><input type="password" value="${Login1}" class="l_pwd" name="Login"/></td>
              </tr>
              </c:when>
        	<c:otherwise><tr height="70">
                <td>用户名</td>
                <td><input type="text" value="" class="l_user" name="Login"/></td>
              </tr>
              <tr height="70">
                <td>密&nbsp; &nbsp; 码</td>
                <td><input type="password" value="" class="l_pwd" name="Login"/></td>
              </tr>
              </c:otherwise>
        	</c:choose>
              <tr>
...
$("input[type=checkbox]").click(function(){
	...
	if(flag==true){
		$("form").attr("action","<%=path%>/HistoryCookieServlet");
	}
